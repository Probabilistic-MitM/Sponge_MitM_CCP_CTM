...
from attack.Keccak.Keccak1024.final_resultSHA3_512_round_4_preimage_for_painting  import initial_state_output,intermediate_states_output
...
with open(f"../tex/SHA3-512_round_4_preimage_{first_slice}-{last_slice}.tex", "w", encoding="utf-8") as f:
